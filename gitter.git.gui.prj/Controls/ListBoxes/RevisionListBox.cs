...
namespace gitter.Git.Gui.Controls
{
    ...
    public class RevisionListBox : CustomListBox
    {
        ...
        private void CompleteBranchDragAndDropWithMerge(Branch branch, Revision revision)
        {
            if (branch.IsCurrent)
            {
                try
        ...
        private void CompleteBranchDragAndDropWithReset(Branch branch, Revision revision)
        {
            if (branch.IsCurrent)
            {
